...
public class ChangeApproval1 extends AbstractUpdateExecuter {
	...
	public String makeQuery() {
		...
		String query ="UPDATE reservation SET approval=1 WHERE classroom_name='"
			+ scanner.nextLine()
